...
public class AncestorBenchmark {
    ...
    static void verify(AuthCsesClient client, String label, String docId, String perm,
    ...
    static void bench(AuthCsesClient client, String label, String docId, String perm, String userId) {
        bench(client, label, "document", docId, perm, userId);
    }

    static void bench(AuthCsesClient client, String label, String type, String id, String perm, String userId) {
        // 热身
    ...
    static long[] concurrentBench(AuthCsesClient client, int threads, int totalOps,
    ...
    static void measureCrdbQueries(AuthCsesClient client, String label,
