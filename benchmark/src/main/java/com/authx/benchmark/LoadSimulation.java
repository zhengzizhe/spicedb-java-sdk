    ...
    public static void main(String[] args) throws Exception {
        ...
        client = AuthxClient.builder()
                ...
                .features(f -> f
                        ...
                        .shutdownHook(true))
                .extend(e -> e
                        .policies(com.authx.sdk.policy.PolicyRegistry.builder()
                                .defaultPolicy(com.authx.sdk.policy.ResourcePolicy.builder()
                                        ...
                                        .retry(com.authx.sdk.policy.RetryPolicy.defaults())
                                        .circuitBreaker(com.authx.sdk.policy.CircuitBreakerPolicy.defaults())
                                        .build())
                                .build()))
                .build();
