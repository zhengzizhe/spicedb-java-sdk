package com.authcses.sdk.trace;
 ...
 *   └── authcses.check (SDK span — this class creates it)
 *        └── SpiceDB CheckPermission (traceparent propagated via gRPC)
 * </pre>
 */
public final class TraceContext {

    private static final Tracer TRACER = GlobalOpenTelemetry.getTracer("authcses-sdk", "1.0.0");
     ...
     *
     * <pre>
     * try (var span = TraceContext.startSpan("authcses.check", attrs)) {
     *     result = doCheck();
     *     span.setSuccess();
     * }
     * </pre>
