...
public class RealWorldScenarios {
     ...
     */
    static void feishuDocCollaboration(AuthCsesClient client) {
     ...
     */
    static void folderInheritance(AuthCsesClient client) {
     ...
     */
    static void permissionGateway(AuthCsesClient client) {
        // 先设置一些权限
     ...
     */
    static void renderUiButtons(AuthCsesClient client) {
     ...
     */
    static void transferOwnership(AuthCsesClient client) {
     ...
     * 给整个工程部的人授权查看文档
     */
    static void departmentAccess(AuthCsesClient client) {
        // 先把人加到部门
     ...
     * 场景 7：协作者列表 + 按角色分组
     */
    static void collaboratorList(AuthCsesClient client) {
     ...
     * 场景 8：用户能看哪些文档（反向查询）
     */
    static void userDocumentList(AuthCsesClient client) {
        // 给 alice 在多个文档上设权限
     ...
     * 把用户从一个项目转到另一个项目
     */
    static void crossResourceBatch(AuthCsesClient client) {
     ...
     * 场景 10：查看 SDK 内部指标
     */
    static void sdkMetrics(AuthCsesClient client) {
        // 先跑一些操作让指标有数据
