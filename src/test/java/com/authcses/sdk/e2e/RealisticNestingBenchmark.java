...
public class RealisticNestingBenchmark {
    ...
    static void createGroups(AuthCsesClient client) {
    ...
    static void buildRealisticChain(AuthCsesClient client) {
    ...
    static void createDocuments(AuthCsesClient client) {
    ...
    static void verify(AuthCsesClient client) {
    ...
    static void check(AuthCsesClient client, String type, String id, String perm, String user,
    ...
    static void benchmarkDeepDocCheck(AuthCsesClient client, int threads, int opsPerThread) throws Exception {
    ...
    static void benchmarkGroupInherit(AuthCsesClient client, int threads, int opsPerThread) throws Exception {
    ...
    static void benchmarkNegativeCheck(AuthCsesClient client, int threads, int opsPerThread) throws Exception {
    ...
    static void cleanup(AuthCsesClient client) {
        // Best effort cleanup
