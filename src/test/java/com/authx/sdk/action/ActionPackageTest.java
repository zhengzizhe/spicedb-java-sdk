...
class ActionPackageTest {
    ...
    class GrantActionTests {
        ...
        void grant_singleUser() {
            GrantAction grant = new GrantAction(RES_TYPE, RES_ID, transport, new String[]{"editor"});
        ...
        void grant_multipleUsers() {
            GrantAction grant = new GrantAction(RES_TYPE, RES_ID, transport, new String[]{"viewer"});
        ...
        void grant_multipleRelations_multipleUsers() {
            GrantAction grant = new GrantAction(RES_TYPE, RES_ID, transport, new String[]{"editor", "viewer"});
        ...
        void grant_toSubjects_parsesRef() {
            ...
            Collection<Tuple> tuples = transport.allTuples();
    ...
    class CheckActionTests {
        ...
        void check_by_allowed() {
            CheckAction check = new CheckAction(RES_TYPE, RES_ID, transport, SYNC_EXEC, new String[]{"editor"});
        ...
        void check_byAll_varargs() {
            CheckAction check = new CheckAction(RES_TYPE, RES_ID, transport, SYNC_EXEC, new String[]{"viewer"});
    ...
    class CheckAllActionTests {
        ...
        void checkAll_by_singleUser() {
            CheckAllAction action = new CheckAllAction(RES_TYPE, RES_ID, transport,                     new String[]{"editor", "viewer", "owner"});
        ...
        void checkAll_byAll_matrix() {
            CheckAllAction action = new CheckAllAction(RES_TYPE, RES_ID, transport,                     new String[]{"editor", "viewer"});
        ...
        void checkAll_withConsistency() {
            CheckAllAction action = new CheckAllAction(RES_TYPE, RES_ID, transport,                     new String[]{"editor"});
    ...
    class RevokeActionTests {
        ...
        void revoke_from_singleUser() {
            RevokeAction revoke = new RevokeAction(RES_TYPE, RES_ID, transport, new String[]{"editor"});
        ...
        void revoke_fromSubjects() {
            ...
            RevokeAction revoke = new RevokeAction(RES_TYPE, RES_ID, transport, new String[]{"viewer"});
        ...
        void revoke_multipleRelations() {
            new GrantAction(RES_TYPE, RES_ID, transport, new String[]{"viewer"})
                    .to("user:alice");
            RevokeAction revoke = new RevokeAction(RES_TYPE, RES_ID, transport, new String[]{"editor", "viewer"});
    ...
    class RevokeAllActionTests {
        ...
        void revokeAll_noRelations_removesAll() {
            RevokeAllAction action = new RevokeAllAction(RES_TYPE, RES_ID, transport, null);
        ...
        void revokeAll_emptyRelations_removesAll() {
            RevokeAllAction action = new RevokeAllAction(RES_TYPE, RES_ID, transport, new String[]{});
            RevokeResult result = action.from("user:alice");
        ...
        void revokeAll_specificRelations_removesOnlyMatching() {
            RevokeAllAction action = new RevokeAllAction(RES_TYPE, RES_ID, transport,
    ...
    class BatchBuilderTests {
        ...
        void batch_grant_and_revoke_atomic() {
            ...
            CheckAction check = new CheckAction(RES_TYPE, RES_ID, transport, SYNC_EXEC, new String[]{"owner"});
    ...
    class RelationQueryTests {
        ...
        @Test
        void fetch_all() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, new String[]{});
        ...
        void fetch_nullRelations() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, null);
            List<Tuple> tuples = query.fetch();
        ...
        @Test
        void fetch_filtered() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, new String[]{"editor"});
            List<Tuple> tuples = query.fetch();
        ...
        void fetch_multipleRelations() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, new String[]{"editor", "viewer"});
            List<Tuple> tuples = query.fetch();
        ...
        void fetchExists_false() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, new String[]{"owner"});
        ...
        void fetchSubjectIds() {
            RelationQuery query = new RelationQuery(RES_TYPE, RES_ID, transport, new String[]{"viewer"});
    ...
    class SubjectQueryTests {
        ...
        void fetch_permission() {
            SubjectQuery query = new SubjectQuery(RES_TYPE, RES_ID, transport, DEFAULT_SUBJECT, SYNC_EXEC, "editor", true);
        ...
        @Test
        void fetch_relation() {
            SubjectQuery query = new SubjectQuery(RES_TYPE, RES_ID, transport, DEFAULT_SUBJECT, SYNC_EXEC, "editor", false);
            List<String> ids = query.fetch();
        ...
        @Test
        void fetchFirst_empty() {
            SubjectQuery query = new SubjectQuery(RES_TYPE, RES_ID, transport, DEFAULT_SUBJECT, SYNC_EXEC, "owner", true);
            assertThat(query.fetchFirst()).isEmpty();
        }
        ...
        void fetchExists_false_relation() {
            SubjectQuery query = new SubjectQuery(RES_TYPE, RES_ID, transport, DEFAULT_SUBJECT, SYNC_EXEC, "owner", false);
            assertThat(query.fetchExists()).isFalse();
        }
    ...
    class WhoBuilderTests {
        ...
        @Test
        void withPermission() {
            WhoBuilder who = new WhoBuilder(RES_TYPE, RES_ID, transport, DEFAULT_SUBJECT, SYNC_EXEC);
