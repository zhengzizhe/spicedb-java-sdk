...
class RevokeActionTypedFromTest {
    ...
    void singleTypeInferred() {
        ...
        RevokeAction a = new RevokeAction("document", "d-1", new InMemoryTransport(),
    ...
    void typedOverloadBuildsCanonicalRef() {
        ...
        RevokeAction a = new RevokeAction("document", "d-1", new InMemoryTransport(),
                new String[]{"viewer"}, cache);
        ResourceType<RevokeActionTypedFromTest.R, RevokeActionTypedFromTest.P> userType = ResourceType.of("user", R.class, P.class);
    ...
    void typedOverloadStillValidatesAgainstSchema() {
        ...
        RevokeAction a = new RevokeAction("document", "d-1", new InMemoryTransport(),
                new String[]{"viewer"}, cache);
        ResourceType<RevokeActionTypedFromTest.R, RevokeActionTypedFromTest.P> folderType = ResourceType.of("folder", R.class, P.class);
    ...
    void typedOverloadWithSubRelation() {
        ...
        RevokeAction a = new RevokeAction("document", "d-1", new InMemoryTransport(),
                new String[]{"viewer"}, cache);
        ResourceType<RevokeActionTypedFromTest.R, RevokeActionTypedFromTest.P> groupType = ResourceType.of("group", R.class, P.class);
    ...
    void iterableTypedOverloadWritesN() {
        ...
        RevokeAction a = new RevokeAction("document", "d-1", new InMemoryTransport(),
                new String[]{"viewer"}, cache);
        ResourceType<RevokeActionTypedFromTest.R, RevokeActionTypedFromTest.P> userType = ResourceType.of("user", R.class, P.class);
        RevokeResult result = a.from(userType, List.of("alice", "bob", "carol"));
