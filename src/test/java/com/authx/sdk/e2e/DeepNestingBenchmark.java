...
public class DeepNestingBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var client = AuthxClient.builder()
            ...
            try (var cachedClient = AuthxClient.builder()
                    .connection(c -> c.target("localhost:50051").presharedKey("dev-token"))
     ...
     */
    static void buildNestingChain(AuthxClient client) {
        buildChain(client, 0);
    }

    static void buildChain(AuthxClient client, int chainId) {
        // L0's parent = root
    ...
    static void buildParallelChains(AuthxClient client, int count) {
    ...
    static void grantRootPermissions(AuthxClient client) {
    ...
    static void verifyInheritance(AuthxClient client) {
        String[][] checks = {
    ...
    static void benchmarkConcurrent(AuthxClient client, String type, String id,
    ...
    static void benchmarkConcurrentMultiChain(AuthxClient client, int chains,
    ...
    static void cleanup(AuthxClient client, int chains) {
        try {
