...
class SpiAdditionalTest {
    ...
    @Nested class SdkClockTest {
        ...
        @Test void fixedClock() {
            SdkClock.Fixed clock = new SdkClock.Fixed(1000L);
    ...
    @Nested class SdkInterceptorTest {
        @Test void operationContextFields() {
            SdkInterceptor.OperationContext ctx = new SdkInterceptor.OperationContext(
        ...
        @Test void operationContextTypedAttributes() {
            ...
            AttributeKey<String> key = AttributeKey.withDefault("test-key", String.class, "default-val");
    ...
    @Nested class TelemetrySinkTest {
        @Test void noopDoesNotThrow() {
            assertThatNoException().isThrownBy(() ->
                TelemetrySink.NOOP.send(List.of(Map.of("action", "CHECK"))));
        }
    }
}
